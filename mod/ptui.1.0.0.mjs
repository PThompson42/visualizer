...
//*--------------------------------      LANGUAGE ITEMS
export function enableMultilingual(langs, trans) {
...
export function changeLanguage(index) {
...
export class AO {
    ...
    static translate(text) {
        if (AO.MULTILINGUAL) {
            ...
            if (index > -1) {
                return AO.translations[index][AO.curLang]
            } else {
                return text
            }
        } else {
...
export class DraggableWindow extends Div {
    ...
    title(text) {
        this.titlebar.updateCaption(text)
        return this
    }
}
//*--------------------  BUTTONS
...
export class HoldButton extends AO {
    constructor(id, action, delta, callback, caption, parentID) {
        super({ id: id, parentID: parentID, type: "button" })
...
export class LabelBil extends Label {
...
export class TextArea extends AO {
    constructor(id, caption, parentID = null) {
        super({ id: id, parentID: parentID, type: "textarea" })
        this.updateCaption(caption)
    }
}
...
export class CustomCheckbox extends Div {
...
export class CustomToggleSwitch extends Div {
    constructor(id, parentID, clickCallback) {
        super(id, parentID)
        this.bOn = false
        this.listenForClicks(this.clkHandler.bind(this))
...
export class SelectionBox extends AO {
...
export class Canvas extends AO {
    ...
    getTextSize(txt, size, bBold = false) {
        let ad = ""
        if (bBold) {
            ad = "bold "
        }
        this.ctx.font = ad + String(size) + "px " + this._font
...
export class svgPolyline extends SVGObject {
    constructor(id, parentID) {
...
export class HorizontalStackManager extends Container {
...
export class HorizStackPane extends AO {
